<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $flavor = $_POST['3layerCakeFlavors'];
    $size = $_POST['3layerSize'];
    $filling = $_POST['3layerFilling'];
    $vegan = $_POST['vegan10'];
    ...
    $path = 'upload/' . $_FILES["3LayerUploadImg"]["name"];
    move_uploaded_file($_FILES["3LayerUploadImg"]["tmp_name"], $path);
...
if(isset($_POST['submitMobile'])){
  ...
  $mail->FromName = "Order at Banza's Bakery";
  $mail->Sender = $from;
  $to = "liseidybueno@gmail.com"; //email address to be sent to
  $mail->addAddress($to);
