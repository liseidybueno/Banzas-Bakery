<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $flavor = $_POST['sheetCakeFlavor'];
    $size = $_POST['sheetCakeSize'];
    $filling = $_POST['sheetCakeFilling'];
    $vegan = $_POST['vegan10'];
    ...
    $path = 'upload/' . $_FILES["sheetcakesUploadImg"]["name"];
    move_uploaded_file($_FILES["sheetcakesUploadImg"]["tmp_name"], $path);
